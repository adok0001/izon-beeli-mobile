...
import { etymologyAdminRouter, etymologyRouter } from "./routes/etymology.js";
...
import { wordProgressRouter } from "./routes/word-progress.js";
...
import { dictionarySensesRouter } from "./routes/dictionary-senses.js";
import { sentenceCorpusRouter } from "./routes/sentence-corpus.js";
...
app.route("/dictionary-senses", dictionarySensesRouter);
app.route("/etymology", etymologyRouter);
app.route("/etymology/admin", etymologyAdminRouter);
...
app.route("/sentence-corpus", sentenceCorpusRouter);
