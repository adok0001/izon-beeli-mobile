  ...
  return (
    <Modal visible transparent animationType="fade" onRequestClose={onClose}>
      <Pressable onPress={onClose} style={{ flex: 1, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(0,0,0,0.5)" }}>
        <Pressable onPress={(e) => e.stopPropagation()} style={{ width: 300, borderRadius: 20, backgroundColor: "white", padding: 24, alignItems: "center", gap: 12 }}>
          ...
          <View style={{ paddingHorizontal: 12, paddingVertical: 4, borderRadius: 20, backgroundColor: "rgba(245, 158, 11, 0.12)" }}>
          ...
          {!isLearned ? (
            ...
            >
              <Text style={{ fontWeight: "700", color: "white", fontSize: 15 }}>Mark as Learned</Text>
            </Pressable>
          ) : (
