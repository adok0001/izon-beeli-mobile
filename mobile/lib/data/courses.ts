...
export const COURSES: CourseEntry[] = [
  ...
  {
    id: "course-izon-fw",  languageId: "izon", order: 1, level: "beginner", lessonsCount: 11, courseType: "first_words",
  ...
  {
    id: "course-izon-ss", languageId: "izon", order: 2, level: "beginner", lessonsCount: 4, courseType: "sound_script",
  ...
  {
    id: "course-izon-nt", languageId: "izon", order: 3, level: "beginner", lessonsCount: 8, courseType: "numbers_trade",
  ...
  {
    id: "course-izon-cm",  languageId: "izon", order: 4, level: "beginner", lessonsCount: 3, courseType: "communicative",
  ...
  {
    id: "course-izon-ot",  languageId: "izon", order: 5, level: "intermediate", lessonsCount: 5, courseType: "oral_tradition",
  ...
  {
    id: "course-izon-sg", languageId: "izon", order: 6, level: "beginner", lessonsCount: 3, courseType: "songs",
  ...
  // Yoruba
  {
    id: "course-yoruba-sg", languageId: "yoruba", order: 3, level: "beginner", lessonsCount: 3, courseType: "songs",
  ...
  {
    id: "course-yoruba-fw",  languageId: "yoruba", order: 1, level: "beginner", lessonsCount: 3, courseType: "first_words",
  ...
  {
    id: "course-yoruba-ot",  languageId: "yoruba", order: 2, level: "intermediate", lessonsCount: 2, courseType: "oral_tradition",
  ...
  // Igbo
  {
    id: "course-igbo-sg", languageId: "igbo", order: 2, level: "beginner", lessonsCount: 3, courseType: "songs",
  ...
  {
    id: "course-igbo-fw",  languageId: "igbo", order: 1, level: "beginner", lessonsCount: 3, courseType: "first_words",
  ...
  // Hausa
  {
    id: "course-hausa-sg", languageId: "hausa", order: 2, level: "beginner", lessonsCount: 3, courseType: "songs",
  ...
  {
    id: "course-hausa-fw",  languageId: "hausa", order: 1, level: "beginner", lessonsCount: 2, courseType: "first_words",
  ...
  // Swahili
  {
    id: "course-swahili-sg", languageId: "swahili", order: 3, level: "beginner", lessonsCount: 3, courseType: "songs",
  ...
  {
    id: "course-swahili-fw",  languageId: "swahili", order: 1, level: "beginner", lessonsCount: 3, courseType: "first_words",
  ...
  {
    id: "course-swahili-ot",  languageId: "swahili", order: 2, level: "intermediate", lessonsCount: 2, courseType: "oral_tradition",
  ...
  // Amharic
  {
    id: "course-amharic-sg", languageId: "amharic", order: 2, level: "beginner", lessonsCount: 3, courseType: "songs",
  ...
  {
    id: "course-amharic-fw", languageId: "amharic", order: 1, level: "beginner", lessonsCount: 3, courseType: "first_words",
  ...
  // Akan (Twi)
  {
    id: "course-akan-sg", languageId: "akan", order: 2, level: "beginner", lessonsCount: 3, courseType: "songs",
  ...
  {
    id: "course-akan-fw", languageId: "akan", order: 1, level: "beginner", lessonsCount: 3, courseType: "first_words",
  ...
  // Wolof
  {
    id: "course-wolof-sg", languageId: "wolof", order: 2, level: "beginner", lessonsCount: 3, courseType: "songs",
  ...
  {
    id: "course-wolof-fw", languageId: "wolof", order: 1, level: "beginner", lessonsCount: 2, courseType: "first_words",
  ...
  // Egyptian Arabic
  {
    id: "course-arabic-egyptian-sg", languageId: "arabic-egyptian", order: 2, level: "beginner", lessonsCount: 3, courseType: "songs",
  ...
  {
    id: "course-arabic-egyptian-fw", languageId: "arabic-egyptian", order: 1, level: "beginner", lessonsCount: 3, courseType: "first_words",
  ...
  // Somali
  {
    id: "course-somali-sg", languageId: "somali", order: 2, level: "beginner", lessonsCount: 3, courseType: "songs",
  ...
  {
    id: "course-somali-fw", languageId: "somali", order: 1, level: "beginner", lessonsCount: 2, courseType: "first_words",
  ...
  // Bambara
  {
    id: "course-bambara-sg", languageId: "bambara", order: 2, level: "beginner", lessonsCount: 3, courseType: "songs",
  ...
  {
    id: "course-bambara-fw", languageId: "bambara", order: 1, level: "beginner", lessonsCount: 2, courseType: "first_words",
  ...
  // Tamazight
  {
    id: "course-tamazight-sg", languageId: "tamazight", order: 2, level: "beginner", lessonsCount: 3, courseType: "songs",
  ...
  {
    id: "course-tamazight-fw", languageId: "tamazight", order: 1, level: "beginner", lessonsCount: 2, courseType: "first_words",
  ...
  // Kinyarwanda
  {
    id: "course-kinyarwanda-sg", languageId: "kinyarwanda", order: 2, level: "beginner", lessonsCount: 3, courseType: "songs",
  ...
  {
    id: "course-kinyarwanda-fw", languageId: "kinyarwanda", order: 1, level: "beginner", lessonsCount: 2, courseType: "first_words",
  ...
  // Ewe
  {
    id: "course-ewe-sg", languageId: "ewe", order: 2, level: "beginner", lessonsCount: 3, courseType: "songs",
  ...
  {
    id: "course-ewe-fw", languageId: "ewe", order: 1, level: "beginner", lessonsCount: 2, courseType: "first_words",
