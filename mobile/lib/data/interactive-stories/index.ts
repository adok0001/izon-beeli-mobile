 ...
 * entry exists here for its `storyId` (see `hasInteractiveStory`). Films that
 * are grouped mini-series (e.g. the Bou Mie films sharing one `storyId`) have no
 * entry here and fall through to their detail screen instead of a dead route.
 */
