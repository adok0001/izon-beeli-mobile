  ...
  welcome: {
    ...
    features: [
      ...
      },
      {
        ...
        color: "#0ea5e9",
        bgColor: "#e0f2fe",
        titleKey: "onboarding.welcomeJournalTitle",
        detailKey: "onboarding.welcomeJournalDetail",
      },
      {
        icon: "newspaper.fill",
        color: "#9333ea",
      ...
      },
      {
        ...
        color: "#059669",
        bgColor: "#d1fae5",
        titleKey: "onboarding.welcomeProfileTitle",
        detailKey: "onboarding.welcomeProfileDetail",
      },
      {
        icon: "checkmark.circle.fill",
        color: "#16a34a",
        bgColor: "#dcfce7",
        titleKey: "onboarding.checklistIntro",
        detailKey: "onboarding.checklistIntroDetail",
      },
      {
        icon: "quote.bubble.fill",
        color: "#d946ef",
        bgColor: "#f3e8ff",
        titleKey: "onboarding.culturalProverbTitle",
        detailKey: "onboarding.culturalProverbDetail",
      },
      {
        icon: "book.pages.fill",
        color: "#f59e0b",
        bgColor: "#fef3c7",
        titleKey: "onboarding.culturalHeritageTitle",
        detailKey: "onboarding.culturalHeritageDetail",
      },
      {
        icon: "heart.fill",
        color: "#ef4444",
        bgColor: "#fee2e2",
        titleKey: "onboarding.culturalValuesTitle",
        detailKey: "onboarding.culturalValuesDetail",
      },
    ],
  },
  learn: {
