...
export default function WordDetailScreen() {
  ...
  const earlyDerived = entry ? deriveEntryDisplay(entry, uiLanguage) : null;
  const englishText = earlyDerived?.englishText ?? "";
  ...
  const derived = deriveEntryDisplay(entry, uiLanguage);
  const { effectiveAudioUrl, displayPronunciation, categoryLabel } = derived;
