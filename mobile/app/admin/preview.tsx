...
export default function PreviewScreen() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: M.bg }} edges={["top"]}>
      <View style={{ flexDirection: "row", alignItems: "center", gap: 12, paddingHorizontal: 16, paddingTop: 8, paddingBottom: 12, backgroundColor: M.ink }}>
        ...
        <View>
          <Text style={{ fontSize: 18, fontWeight: "900", color: M.parchment }}>Preview</Text>
          <Text style={{ fontSize: 11, color: M.textDim }}>Draft — not yet published</Text>
        </View>
      </View>
