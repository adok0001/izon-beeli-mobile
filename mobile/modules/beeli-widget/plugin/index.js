...
const withIosAppGroup = (config) => (0, config_plugins_1.withEntitlementsPlist)(config, (mod) => {
...
const withIosWidgetExtension = (config) => (0, config_plugins_1.withXcodeProject)(config, (mod) => {
    ...
    const alreadyAdded = Object.values(nativeTargets).some((t) => typeof t === "object" &&
    ...
    const sharedSettings = {
        ...
        PROVISIONING_PROFILE_SPECIFIER: '"6fa74258-249d-4bb2-98ea-09c5d2b47a56"',
...
const withIosWidgetSources = (config) => (0, config_plugins_1.withDangerousMod)(config, [
    "ios",
    (mod) => {
...
const withAndroidWidgets = (config) => (0, config_plugins_1.withAndroidManifest)(config, (mod) => {
...
const withAndroidWidgetResources = (config) => (0, config_plugins_1.withDangerousMod)(config, [
    "android",
    (mod) => {
        const srcBase = path.join(__dirname, "../android/src/main/res");
        const destBase = path.join(mod.modRequest.platformProjectRoot, "app/src/main/res");
        ...
        // Copy Kotlin sources
        const srcKt = path.join(__dirname, "../android/src/main/java/com/izonbeeli/app/widget");
        const destKt = path.join(mod.modRequest.platformProjectRoot, "app/src/main/java/com/izonbeeli/app/widget");
...
exports.default = withBeeliWidget;
