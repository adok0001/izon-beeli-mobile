...
// Mirrors the server's `elderMiddleware` (admins or elders only) and mobile's
// `canReviewApplications` — keep the three in lockstep.
function canReviewApplications(me: UserMe): boolean {
  return me.isAdmin || me.reviewerRole === "elder";
}
...
export default function ApplicationsPage() {
  ...
  const { data: me } = useMe();
  const allowed = useStudioRoleGate(me === undefined ? undefined : canReviewApplications(me));
