...
import { useStudioRoleGate } from "@/app/(studio)/_components/use-studio-role-gate";
...
// Mirrors the server's `professorMiddleware` (admins, professors, or elders)
// and mobile's `canManageBounties` — keep the three in lockstep.
function canManageBounties(me: UserMe): boolean {
  return me.isAdmin || me.reviewerRole === "professor" || me.reviewerRole === "elder";
}
...
export default function BountiesPage() {
  ...
  const { data: me } = useMe();
  const allowed = useStudioRoleGate(me === undefined ? undefined : canManageBounties(me));
