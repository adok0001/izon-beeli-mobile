...
export default async function LearnLanguagePage({
  ...
  const jsonLd = {
    ...
    itemListElement: courses.map((c, i) => ({
      ...
      item: {
        "@type": "Course",
        name: localizePair(c.titleTranslations, c.title, "en"),
        description: localizePair(c.descriptionTranslations, c.description, "en"),
        url: `${BASE_URL}/learn`,
        provider: {
          "@type": "Organization",
          name: "Aurufie (Beeli)",
                  ...
                  >
                    <div className="flex items-start justify-between gap-3 mb-2">
                      <h3 className="font-semibold text-neutral-900 dark:text-white group-hover:text-brand-600 dark:group-hover:text-brand-400 transition-colors">
                        {localizePair(course.titleTranslations, course.title, "en")}
                      </h3>
                    ...
                    <p className="text-sm text-neutral-500 dark:text-neutral-400 line-clamp-2 mb-3">
                      {localizePair(course.descriptionTranslations, course.description, "en")}
                    </p>
