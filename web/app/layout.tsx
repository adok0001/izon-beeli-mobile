...
const TRANSLATIONS = { en, fr, pcm, ar, pt } as const;

const OG_LOCALES: Record<UiLanguage, string> = {
  en: "en_US",
  fr: "fr_FR",
  pcm: "en_NG",
  ar: "ar_AR",
...
export default async function RootLayout({
  ...
  return (
    <html lang={lang} dir={isRtlLanguage(lang) ? "rtl" : "ltr"} suppressHydrationWarning>
